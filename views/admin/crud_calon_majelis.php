<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1>Manajemen Calon Majelis Pusat</h1>
        <a href="<?php echo BASE_URL; ?>/admin/createMajelis" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="<?php echo BASE_URL; ?>/admin/editMajelis/<?php echo $c['id']; ?>"
                                                class="btn btn-sm btn-warning" title="Edit">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>

                                            <form action="<?php echo BASE_URL; ?>/admin/deleteMajelis/<?php echo $c['id']; ?>"
